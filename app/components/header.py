...
def header() -> rx.Component:
    return rx.fragment(
        ...
        rx.el.header(
            ...
            rx.el.div(
                rx.cond(
                    ...
                    rx.el.div(
                        ...
                        class_name="flex items-center gap-2 justify-center px-3 py-1.5 bg-muted/30 rounded-md",
                    ),
                ),
                        ...
                        rx.el.div(
                            rx.el.div(
                                rx.el.p(
                                    ...
                                    class_name="text-xs font-medium text-foreground truncate max-w-[150px]",
                                ),
                                rx.el.p(
                            ...
                            rx.image(
                                ...
                                class_name="h-8 w-8 rounded-full border border-card shrink-0",
                            ),
                            rx.icon(
                                "chevron-down",
            ...
            class_name="flex items-center h-12 px-4 bg-card/95 border-b sticky top-0 z-10 shadow-sm ios-blur shrink-0",
        ),
    )