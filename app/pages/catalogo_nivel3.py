import reflex as rx
from app.states.catalogo_nivel3_state import CatalogoNivel3State
from app.states.parametros_generales_state import ParametrosGeneralesState


def list_item(item: dict) -> rx.Component:
    is_selected = CatalogoNivel3State.selected_item["codigo"] == item["codigo"]
    return rx.el.div(
        rx.el.div(
        ...
        on_click=lambda: CatalogoNivel3State.select_item(item),
        class_name=rx.cond(
            is_selected,
...
def form_section() -> rx.Component:
    return rx.el.div(
        rx.el.div(
            rx.el.h3(
                rx.cond(
                    CatalogoNivel3State.selected_item["codigo"] == 0,
                    "Nuevo Registro",
                    "Editar Registro",
                ),
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.label(
                    rx.el.input(
                        type="checkbox",
                        checked=CatalogoNivel3State.selected_item["activo"],
                        on_change=CatalogoNivel3State.set_selected_item_active,
            ...
            rx.cond(
                ...
                rx.el.div(
                    rx.el.div(
                        ...
                        rx.el.span(
                            CatalogoNivel3State.selected_item["fecha_creacion"],
                    ...
                    rx.el.div(
                        ...
                        rx.el.span(
                            CatalogoNivel3State.selected_item["fecha_modificacion"],
                            class_name="text-xs font-medium ml-1",
                        ),
...
def catalogo_nivel3_page() -> rx.Component:
    return rx.el.div(
        rx.el.div(
            rx.el.h2(
            ...
            rx.el.div(
                rx.el.label(
                    rx.el.input(
                        type="checkbox",
                        checked=CatalogoNivel3State.show_inactive,
                        on_change=CatalogoNivel3State.set_show_inactive,
                ...
                rx.el.button(
                    ...
                    "Nuevo",
                    on_click=CatalogoNivel3State.new_item,
        ...
        rx.el.div(
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.input(
                        placeholder="Buscar...",
                        on_change=CatalogoNivel3State.set_search_query,
                ...
                rx.el.div(
                    rx.foreach(CatalogoNivel3State.filtered_items, list_item),
            ...
            rx.el.div(
                rx.cond(
                    CatalogoNivel3State.is_editing,
                    form_section(),
                    rx.el.div(
                        rx.icon(
                            "mouse-pointer-click",
