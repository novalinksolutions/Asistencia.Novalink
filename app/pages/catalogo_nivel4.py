import reflex as rx
from app.states.catalogo_nivel4_state import CatalogoNivel4State
from app.states.parametros_generales_state import ParametrosGeneralesState


def list_item(item: dict) -> rx.Component:
    is_selected = CatalogoNivel4State.selected_item["codigo"] == item["codigo"]
    return rx.el.div(
        rx.el.div(
        ...
        on_click=lambda: CatalogoNivel4State.select_item(item),
        class_name=rx.cond(
            is_selected,
...
def form_section() -> rx.Component:
    return rx.el.div(
        rx.el.div(
            rx.el.h3(
                rx.cond(
                    CatalogoNivel4State.selected_item["codigo"] == 0,
                    "Nuevo Registro",
                    "Editar Registro",
                ),
            ...
            rx.el.div(
                rx.el.button(
                    "Cancelar",
                    on_click=CatalogoNivel4State.cancel_edit,
                ...
                rx.el.button(
                    ...
                    "Guardar",
                    on_click=CatalogoNivel4State.save_item,
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    ...
                    default_value=CatalogoNivel4State.selected_item["codigo"],
                    key=CatalogoNivel4State.selected_item["codigo"],
                ),
                class_name="mb-4",
            ),
            rx.el.div(
                ...
                rx.el.input(
                    on_change=CatalogoNivel4State.set_selected_item_description,
                    ...
                    default_value=CatalogoNivel4State.selected_item["descripcion"],
                ),
                class_name="mb-4",
            ),
            rx.el.div(
                rx.el.label(
                    rx.el.input(
                        type="checkbox",
                        checked=CatalogoNivel4State.selected_item["activo"],
                        on_change=CatalogoNivel4State.set_selected_item_active,
            ...
            rx.cond(
                ...
                rx.el.div(
                    rx.el.div(
                        ...
                        rx.el.span(
                            CatalogoNivel4State.selected_item["fecha_creacion"],
                    ...
                    rx.el.div(
                        ...
                        rx.el.span(
                            CatalogoNivel4State.selected_item["fecha_modificacion"],
                            class_name="text-xs font-medium ml-1",
                        ),
...
def catalogo_nivel4_page() -> rx.Component:
    return rx.el.div(
        rx.el.div(
            rx.el.h2(
            ...
            rx.el.div(
                rx.el.label(
                    rx.el.input(
                        type="checkbox",
                        checked=CatalogoNivel4State.show_inactive,
                        on_change=CatalogoNivel4State.set_show_inactive,
                ...
                rx.el.button(
                    ...
                    "Nuevo",
                    on_click=CatalogoNivel4State.new_item,
        ...
        rx.el.div(
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.input(
                        placeholder="Buscar...",
                        on_change=CatalogoNivel4State.set_search_query,
                ...
                rx.el.div(
                    rx.foreach(CatalogoNivel4State.filtered_items, list_item),
            ...
            rx.el.div(
                rx.cond(
                    CatalogoNivel4State.is_editing,
                    form_section(),
                    rx.el.div(
                        rx.icon(
                            "mouse-pointer-click",
